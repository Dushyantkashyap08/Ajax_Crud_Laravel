...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="container pt-3">
              <button type="button" class="btn btn-primary" id="add_todo">  Add Record </button>
              ...
              <div class="modal-content">
                <form id="form_todo">
                    <div class="modal-header">
                      <h4 class="modal-title" id="modal_title">Add Record</h4>
                    </div>
                    <!-- Modal body -->
                    <div class="modal-body">
                      <input type="hidden" name="id" id="id">
                      <input type="text" name="name" id="name_todo" class="form-control" placeholder="Enter Record ...">
                    </div>
                    <!-- Modal footer -->
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                $.ajaxSetup({
                    headers:{
                        'x-csrf-token' : $('meta[name="csrf-token"]').attr('content') //setting up csrf_token globally
                    }
                });
            });
